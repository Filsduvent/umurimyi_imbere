...
class AgentDrawerWidget extends StatefulWidget {
  const AgentDrawerWidget({Key? key}) : super(key: key);

  @override
  State<AgentDrawerWidget> createState() => _AgentDrawerWidgetState();
}

class _AgentDrawerWidgetState extends State<AgentDrawerWidget> {
  String? username = "";
  String? image = "";
  String? email = "";
        ...
        children: [
          ...
          InkWell(
            ...
            child: ListTile(
                ...
                title: BigText(text: "Add Products")),
          ),
